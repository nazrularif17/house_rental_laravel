...
<body>
    ...
    <div class="container" id="container">
        <div class="form-container sign-up-container">
            <form action="{{ route ('adminregister') }}" method="post">
                @csrf
                <input type="text" name="customID" placeholder="Admin ID">
                ...
                <button type="submit" value="adminsignup" name="submit">Sign Up</button>
            </form>
        </div>
        <div class="form-container sign-in-container">
            <form action="{{ route ('adminlogin') }}" method="post">
                @csrf
                <input type="text" placeholder="Admin ID" name="customID"/>
                <input type="password" placeholder="Password" name="password"/>
                <button type="submit" value="adminlogin" name="submit">Log In</button>
            </form>
        </div>
    ...
    <a href="{{ route('student') }}">Are you a student?</a>
</body>
<script>
